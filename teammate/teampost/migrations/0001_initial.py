...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('home', '0006_courses_skills_alter_users_nickname_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post_id', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='requests_post_id', to='teampost.teampost')),
            ],
        ),
        migrations.CreateModel(
            name='TeamMembership',
            fields=[
                ...
                ('team', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='memberships', to='teampost.team')),
            ],
            options={
